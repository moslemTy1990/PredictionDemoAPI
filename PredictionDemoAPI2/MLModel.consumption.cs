...
namespace PredictionDemoAPI2
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"SicknessType")]
            public float[] SicknessType { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Prediction");
            if (labelColumn == null)
            {
                throw new Exception("Prediction column not found. Make sure the name searched for matches the name in the schema.");
            }
